  ...
  return (
    <footer className="bg-brand-deep text-white">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 sm:px-6 md:grid-cols-2 lg:grid-cols-[1.25fr_0.75fr_1fr_1fr] lg:px-8">
        <div>
          ...
          <div className="mt-6 space-y-3 text-sm">
            ...
            {business.contact.email && (
              <a href={business.contact.emailHref} className="flex items-center gap-3 hover:text-brand-sand"><Mail className="h-4 w-4 text-brand-gold" />{business.contact.email}</a>
            )}
            <span className="flex items-center gap-3 text-white/70"><MapPin className="h-4 w-4 text-brand-gold" />{business.address.display}</span>
          </div>
        </div>

        <div>
          <h2 className="text-sm font-bold uppercase tracking-[0.2em] text-brand-sand">Company</h2>
        ...
        <div>
          <h2 className="text-sm font-bold uppercase tracking-[0.2em] text-brand-sand">Services</h2>
          <div className="mt-5 space-y-2.5">
            ...
            <Link to="/services/" className="block pt-1 text-sm font-semibold text-brand-sand">View all services</Link>
          </div>
        </div>

        <div>
          <h2 className="text-sm font-bold uppercase tracking-[0.2em] text-brand-sand">Service Areas</h2>
          ...
          <Link to="/areas/" className="mt-4 inline-block text-sm font-semibold text-brand-sand">View all areas</Link>
        </div>
      </div>
