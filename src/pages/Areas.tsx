      ...
      <main>
        ...
        <section className="bg-white py-16 md:py-24">
          <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
            <div className="max-w-3xl"><p className="text-xs font-bold uppercase tracking-[0.24em] text-brand-gold">Areas We Cover</p><h2 className="mt-3 text-3xl font-bold text-brand-deep sm:text-4xl">Local pages for homes, rural properties and businesses</h2><p className="mt-4 text-base leading-8 text-brand-slate">Select an area to read about common roof types, property needs, nearby coverage and available services.</p></div>
            <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {locations.map((area) => (
                <Link key={area.slug} to={`/${area.slug}/`} className="group rounded-[24px] border border-brand-mist bg-brand-cream/55 p-5 transition hover:-translate-y-1 hover:border-brand-olive/40 hover:bg-white hover:shadow-[0_18px_45px_rgba(22,58,53,.1)]">
                  ...
                  <h3 className="mt-4 text-xl font-bold text-brand-deep">{area.hero.title.replace("Roofing in ", "")}</h3>
