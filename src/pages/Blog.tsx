...
export default function Blog() {
  return (
    <div className="min-h-screen bg-roof-cream">
      <SEO title={`Hunter Valley Roofing Blog | ${business.name}`} description={`Read practical Hunter Valley roofing guides about roof leaks, storm damage, Colorbond and tile roofing, maintenance, restoration and replacement.`} canonical={`${business.url}/blog/`} />
      <Header />
      <main>
        <PageHero eyebrow="Roofing Advice" title="Practical guides for Hunter Valley property owners" description="Learn how to recognise common roof problems, compare roofing options and prepare useful information before arranging an inspection." image="/images/roof-hero.webp" />
