        ...
        <section className="bg-white py-16 md:py-24">
          <div className="mx-auto grid max-w-7xl gap-10 px-5 sm:px-6 lg:grid-cols-[.8fr_1.2fr] lg:px-8">
            <div>
              ...
              <p className="mt-4 text-base leading-8 text-roof-slate">Describe the wall location, height, length and purpose. Photos of the site can help us understand the project.</p>
            ...
            <div className="rounded-[30px] border border-roof-mist bg-roof-cream/60 p-5 sm:p-8">
              <h2 className="text-2xl font-bold text-roof-deep">Request a retaining wall quote</h2>
              <p className="mt-2 text-sm leading-6 text-roof-slate">Complete the form and include enough detail for us to understand the property and wall requirements.</p>
