    ...
    <section className="bg-roof-deep py-16 text-white md:py-24">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 sm:px-6 lg:grid-cols-[.9fr_1.1fr] lg:px-8">
        <div>
          ...
          <Link to="/contact-us/" className="mt-7 inline-flex items-center gap-2 text-sm font-bold text-roof-sand">Discuss your project <ArrowRight className="h-4 w-4" /></Link>
        </div>
