  ...
  return (
    <section className="bg-white py-16 md:py-24">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        <div className="max-w-2xl"><p className="text-xs font-bold uppercase tracking-[0.24em] text-roof-copper">What We Look After</p><h2 className="mt-3 text-3xl font-bold text-roof-deep sm:text-4xl">Roofing systems, not isolated patches</h2><p className="mt-4 text-base leading-8 text-roof-slate">A leak or damaged component can be connected to drainage, flashings, roof penetrations or ageing materials elsewhere. We consider the surrounding roof details before recommending work.</p></div>
